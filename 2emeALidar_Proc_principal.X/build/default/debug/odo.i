...
void calcul_distance_roues(void) {
    ...
    odo.distance_gauche_mm = (3.14159265359f * 32.43f * odo.ticks_gauche) / 180;
    odo.distance_gauche_mm *= 1.007f;
    odo.distance_gauche_int = (signed long)odo.distance_gauche_mm;

    odo.ticks_droite = Motors_Get_Enc_Right();
    odo.distance_droite_mm = (3.14159265359f * 32.43f * odo.ticks_droite) / 180;
    odo.distance_droite_mm *= 1.007f;
...
void calcul_angle_robot(float dist_gauche, float dist_droite) {
    ...
    float delta_theta = (delta_d - delta_g) / 109.5f;
    odo.angle_rad += delta_theta;
    odo.angle_deg = odo.angle_rad * (180.0f / 3.14159265359f);
